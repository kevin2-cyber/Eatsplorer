package com.kimikevin.eatsplorer.view.utils;
...
public abstract class PermissionUtils {
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(requireActivity())
                    .setMessage(com.kimikevin.eatsplorer.R.string.location_permission_denied)
        ...
        public void onDismiss(@NonNull DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(), com.kimikevin.eatsplorer.R.string.permission_required_toast,
    ...
    public static class RationaleDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(requireActivity())
                    .setMessage(com.kimikevin.eatsplorer.R.string.permission_rationale_location)
        ...
        public void onDismiss(@NonNull DialogInterface dialog) {
            ...
            if (finishActivity) {
                Toast.makeText(getActivity(),
                                com.kimikevin.eatsplorer.R.string.permission_required_toast,
                                Toast.LENGTH_SHORT)
                        .show();
                requireActivity().finish();
            }
