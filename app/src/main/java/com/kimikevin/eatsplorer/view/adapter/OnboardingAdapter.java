...
import com.kimikevin.eatsplorer.view.OnboardingFragment;
...
//    public OnboardingAdapter(Context context, Onboarding[] onboarding) {
...
//    }
    ...
    public Fragment createFragment(int position) {
        ...
        args.putInt(OnboardingFragment.ARG_OBJECT,position);
